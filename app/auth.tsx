...
//   return (
//     <LinearGradient colors={["#0B181E", "#005E09"]} style={styles.container}>
//       <View style={styles.content}>
//         <View style={styles.iconContainer}>
//           <Ionicons name="medical" size={80} color="white" />
//         </View>

//         <Text style={styles.title}>Medics</Text>
//         <Text style={styles.subtitle}>Let’s Get You Close to Your Patients</Text>
